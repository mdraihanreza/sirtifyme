...
function SubuserPage() {
    ...
    var handleDelete = async (user_id) => {
        setLoader(true)
        if (user_id) {
            var response = await UserService.getDeleteSubuser(user_id)
    ...
    return (
        <>
            ...
            <Modal className='subuser_modal' show={showModal} onHide={closeModal}>
                <Modal.Header closeButton>
                    <Modal.Title>Create Subuser</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form onSubmit={handleSubmit(dataSubmit)}>
                        <Form.Group controlId="name" className='bottom_spacing'>
                        ...
                        <Form.Group controlId="phonenumber" className='bottom_spacing'>
                            ...
                            <div className='clearfix'>
                                <div className='country_code'>
                                    <Form.Select className="countrydropdown" {...register("country_code")}>
                                        {countryCodes &&
