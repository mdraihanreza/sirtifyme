...
function Education() {
    ...
    const handleCheckboxChange = () => {
        setIsChecked(true);
        setInputColor(isChecked ? 'red' : 'blue'); // Change 'blue' to your desired color
      };
    ...
    var getEducation = async () => {
        ...
        if (token !== null) {
            console.log("repeat");
            var response = await UserService.getEducation(user.tokendata)
            console.log("education ", response.data)

            if (response.data.success) {
                var responsedata = response.data.additional_data.map((i, index) => ({
                    additiona_education_id: i.additiona_education_id,
                    edu_name: i.edu_name,
    ...
    const SaveEducationInfo = async (select_index) => {
        ...
        fields.map(async (item, index) => {
            if (index === select_index) {
                ...
                var response = await UserService.updateeducationAdditional(fdata)
    ...
    const removeaddmore = async (data) => {
        console.log(data.additiona_education_id)
        if (data.additiona_education_id) {
            var response = await UserService.getRemoveEducation(data.additiona_education_id)
    ...
    const dataSubmit = async (data) => {
        ...
        var response = await UserService.updateeducation(fdata);
        ...
        <>
            ...
            <div className="tab-pane fade" id="education" role="tabpanel">
                ...
                <form method="post" onSubmit={handleSubmit(dataSubmit)}>
                    <div className="row">
                    <input 
          type="checkbox" class="slider round"
          checked={isChecked}
          onChange={handleCheckboxChange}
        />
                {/* <input type="checkbox" onChange={toggleInputVisibility} class="slider round"/> */}
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <label>Undergraduate</label>
                                    ...
                                    <input
                                        type="text"  style={{ borderBlockColor: inputColor }}
