...
function Education() {
    ...
    const handleToggleChange = () => {
        setToggleData(!toggledata); // Toggle the state
    };
        ...
        if (token !== null) {
            ...
            if (response.data.success) {
                ...
                reset({
                    ...
                    g_status:response.data.data.g_status,
                    med_status:response.data.data.med_status,
                        ...
                        {fields.map((item, index) => (
                            <div className="row" key={index}>
                                ...
                                <div className="col-md-2">
                                    ...
                                    <label className="lable_style">Institution name</label>
