...
export const ChangePassword= yup.object({
  new_password: yup.string().trim().min(10,"password length must be 10 characters").required("password required"),
  conpassword: yup.string().trim().min(10,"confirm password length must be 10 characters").required().oneOf([yup.ref("new_password")], "confirm password not match"),
});
...
export const CurrentEmployeSchema =yup.object({
  ...
  // employment_start_date: yup.string().required("choose date"),
  // employment_end_date: yup.string().required("choose date"),
});
...
export const SubuserSchema = yup.object({
  sub_user_type: yup.string().required("User Type Required"),
  name: yup.string().required("Full Name Required"),
  only_mobile_no: yup.string().matches(phoneRegExps, 'Phone number is not valid'),
  email: yup.string().email().required("email required"),
  country_code: yup.string().required("select country code"),
