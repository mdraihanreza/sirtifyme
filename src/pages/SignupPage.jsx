...
import registartionleftimage from '../assets/images/registration-left.png';
...
function Signup() {
    ...
    // Event handler for the country code dropdown change
    ...
    const { register, handleSubmit, formState:{ errors },watch,reset  } = useForm({
      ...
      const onSubmit=async(data) =>{
        ...
        console.log(data);
        var response=await UserService.postSignup(fdata);
        ...
        if(response.data.success==true)
        {
            ...
            if(data.user_type=='1'|| data.user_type=='2' || data.user_type=='3'){
                navigate(`/login`,{state:{provider_status:true}})
            }else{
                navigate(`/login`,{state:{provider_status:false}})
                ...
                <div className="registration-form-inner">
                    <div className="row">
                        ...
                        <div className="col-lg-5">
                            ...
                            {!location.state.provider_status? <h3>Signup As Non-Provider </h3>: <h3>Signup As  Provider</h3>}
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" {...register("name")} className="form-control" placeholder="" />
                                    <p style={{ color: 'red' }} className='form-field-error'>{errors.name?.message}</p>
                                </div>
                                <div className="form-group">
                                    <label>Email ID</label>
                                    <input type="email"{...register("email")}  className="form-control" placeholder="" />
                                ...
                                <input type="number" {...register("only_mobile_no")} className="form-control phoneinput" placeholder="" />
                                <p style={{ color: 'red' }} className='form-field-error'>{errors.country_code?.message}</p>
                                <p style={{ color: 'red' }} className='form-field-error'>{errors.only_mobile_no?.message}</p>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    placeholder="********"
                                />
                                <p style={{ color: 'red' }} className='form-field-error'>{errors.conpassword?.message}</p>
                            </div>
                            <input
                                type="submit"
                                Value="Register"
