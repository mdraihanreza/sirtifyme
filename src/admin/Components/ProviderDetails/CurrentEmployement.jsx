...
console.log(response,'response')
            if (response.data.success) {
                var responsedata = response.data.additional_data.map((i, index) => ({
                    additional_employement_id: i.additional_employement_id,
                    job_name: i.job_name,
    ...
    const SaveEmployementInfo = async (select_index) => {
        ...
        fields.map(async (item, index) => {
            if (index === select_index) {
                ...
                var response = await AdminService.updateemployementAdditional(fdata)
    ...
    const removeaddmore = async (data) => {
        console.log(data.additional_employement_id)
        if (data.additional_employement_id) {
            var response = await AdminService.getRemoveemployee(data.additional_employement_id)
            if (response.data.success) {
    ...
    const dataSubmit = async (data) => {
        ...
        fdata.append("user_id", user_id);
        var response = await AdminService.PostEmployee(fdata);
