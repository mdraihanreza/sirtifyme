...
function Certifications() {
    ...
    var getCertificateData = async () => {
        ...
        if (token !== null) {
            console.log(token, 'token')
            console.log("repeat");
            var response = await AdminService.getCertificate(user_id)
            console.log("license ", response.data)

            if (response.data.success) {
                console.log("license ", response.data.additional_data)
                var responsedata = response.data.additional_data.map((i, index) => ({
                    additional_certificate_id: i.additional_certificate_id,
    ...
    const removeaddmore = async (data) => {
        console.log(data)
        if (data.additional_certificate_id) {
            var response = await AdminService.getRemovecertificate(data.additional_certificate_id)
    ...
    const SaveCertificateInfo = async (select_index) => {
        ...
        fields.map(async (item, index) => {
            if (index === select_index) {
                ...
                var response = await AdminService.updateAdditionalCertificate(fdata)
