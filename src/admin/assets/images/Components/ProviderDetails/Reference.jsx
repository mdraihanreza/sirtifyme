...
function References() {
    ...
    var getReferenceData = async () => {
        ...
        if (token !== null) {
            console.log("repeat");
            var response = await AdminService.getReference(user.tokendata)
    ...
    const dataSubmit = async (data) => {
        ...
        var response = await AdminService.saveReference(fdata);
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" placeholder="" {...register("first_reference")}/>
                        ...
                        <div className="col-md-12">
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" placeholder="" {...register("second_reference")} />
                        ...
                        <div className="col-md-12">
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" placeholder="" {...register("third_reference")}/>
